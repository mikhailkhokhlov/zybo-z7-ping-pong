...
#Clock signal
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports i_system_clock]
create_clock -period 8.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports i_system_clock]

create_generated_clock -name pixel_clock_clk_wiz_0 \
                       -source [get_ports i_system_clock] -edges {1 2 3} \
                       -edge_shift {0.000 16.000 32.000} \
                       [get_pins mmcm0/inst/mmcm_adv_inst/CLKOUT0]

set_false_path -from [get_clocks sys_clk_pin] -to [get_clocks pixel_clock_clk_wiz_0]
...
##Buttons
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports i_reset_btn]
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports i_move_up_btn]
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS33} [get_ports i_move_down_btn]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports i_ckick_btn]
...
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {o_red[2]}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {o_red[3]}]
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {o_blue[0]}]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports {o_blue[1]}]
set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS33} [get_ports {o_blue[2]}]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {o_blue[3]}]


#Pmod Header JD
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {o_green[0]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {o_green[1]}]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {o_green[2]}]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {o_green[3]}]
